...
public class CS_DialogPropertyView : CS_DialogViewBase
{

    public CS_DialogPropertyView() : base("Property View ...") { }
    ...
    public override void UpdateView(Rect editorRect, Rect percentageRect, Event e, CS_DialogGraph currentGraph)
    {
        ...
        {
            currentGraph.selectedDialog.DrawDialogProperties(viewRect);
        }
        GUILayout.Space(30);
