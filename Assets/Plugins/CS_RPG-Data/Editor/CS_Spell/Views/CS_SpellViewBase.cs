...
public class CS_SpellViewBase
{
    ...
    protected CS_SpellGraph currentGraph;

    public CS_SpellViewBase(string title)
    {
        viewTitle = title;
        GetEditorSkin();
    }

    public virtual void UpdateView(Rect editorRect, Rect percentageRect, Event e, CS_SpellGraph CurrentGraph)
    {
        if (viewSkin == null)
        {
            GetEditorSkin();
